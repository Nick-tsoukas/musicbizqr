  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'apple-touch-startup-image', href: '/splash/apple-splash-1536x2048.png', media: '(device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2)' },
      ],
    },
  },
