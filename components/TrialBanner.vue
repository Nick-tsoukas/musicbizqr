<template>
  <div class="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-6 flex justify-between items-center">
    <div>
      <strong>
        Your 30-day trial ends in {{ daysLeft }} 
        {{ daysLeft === 1 ? 'day' : 'days' }}.
      </strong>
...
<style scoped>
/* Customize banner styles as needed */
</style>
