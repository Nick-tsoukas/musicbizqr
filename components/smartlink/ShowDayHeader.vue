<template>
  <div 
    v-if="event"
    class="show-day-header w-full px-4 py-3 bg-gradient-to-r from-orange-500/20 to-amber-500/10 border-b border-orange-400/30"
  >
    <div class="flex items-center justify-between gap-3">
      <div class="flex items-center gap-3 min-w-0">
        ...
        <span class="relative flex h-2.5 w-2.5 shrink-0">
          ...
          <span class="relative inline-flex h-2.5 w-2.5 rounded-full bg-orange-400"></span>
        </span>
      ...
      <button
        @click="handleCta"
        class="shrink-0 px-4 py-2 rounded-lg bg-orange-500 hover:bg-orange-400 text-white text-sm font-semibold transition"
      >
        {{ ctaLabel }}
      </button>
    </div>
