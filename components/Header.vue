<template>
  <header class="bg-black text-white shadow-lg fixed top-0 left-0 right-0 z-50" style="height: var(--header-height);">
  <BackButton
    v-if="showBack"
  ...
  <div class="flex items-center justify-between h-full px-4 mx-auto max-w-5xl">
    ...
    <nav class="hidden md:flex space-x-4">
      ...
      <p v-if="user" @click="logoutUser" class="nav-link cursor-pointer">Logout</p>
  ...
  >
    <div class="flex flex-col items-center h-full space-y-4 py-4">
      ...
      <NuxtLink v-if="user" to="/account" @click="toggleMenu" class="mobile-nav-link">Account</NuxtLink>
    </div>
  </nav>
</header>
