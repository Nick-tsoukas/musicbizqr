<template>
  <div>
    ...
    <!-- container for the first main section -->
     <setion v-if="!loading" class=" z-50 max-h-[100vh]">
     <!-- Hero Section -->
      <div class="relative w-full h-[30vh] md:h-[30vh] bg-red-500">
        <img
      ...
      <section class=" flex flex-col justify-center bg-green  ">
      <!-- Band Name -->
      <div
      ...
      <div class="flex justify-center h-[50vh] ">
        ...
        <!-- Featured Song -->
        <div class="w-full px-6  h-[30vh] bg-red-500 md:max-w-[80vw] md:mx-auto">
        <section v-if="band.data.singlesong" class="">
