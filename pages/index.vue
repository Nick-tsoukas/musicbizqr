  ...
  <div class="bg-white">
    ...
    <main>
      ...
      <div class="relative isolate ">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24  lg:flex  lg:gap-x-10 lg:px-8 ">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Get your sound out</h1>
