<template>
  <div>
    <div class="flex flex-col items-center justify-center md:hidden">
      ...
      <h2 class="pb-8 text-4xl font-bold">Get Your Sound Out</h2>
      <p class="text-center text-xl w-[80vw]">
...
export default {
  ...
  methods: {
    ...
    changeColors() {
      ...
      paths.forEach(path => {
        path.style.fill = this.getRandomColor();
      });
    },
    animateColors() {
      setInterval(this.changeColors, 1500);
    }
  }
};
</script>
