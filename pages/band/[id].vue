  ...
  <div v-if="band && band.data " class="bg-[#000] w-screen  mx-auto">
    ...
    <div v-if="band" class="band-image-container relative w-screen max-h-[600px] p-5 flex flex-col md:flex-row ">
      ...
      <!-- <div class="band-name-bar">
        <h1 class="text-xl md:text-8xl font-bold">{{ band.data.attributes.name }}</h1>
      </div> -->
    </div>
      ...
      <div>
        ...
        <section class="flex gap-4  overflow-x-scroll no-scrollbar">
          <div
            ...
            :key="album.id"
            class="bg-black shadow-lg rounded p-3 min-w-[100%] h-[300px] md:min-w-[500px] md:h-[450px]"
          >
        ...
        <section v-if="albumPlay" class="w-full flex flex-col md:flex-row gap-4 my-20">
          ...
          <div class="flex flex-col gap-6 justify-start md:px-4 w-full md:w-[25%] " >
            ...
            <button class="w-full custom-border bg-[#000] flex justify-center text-white px-2 py-3 items-center relative border-white" > <img src="@/assets/spotify.svg" class="h-8 absolute left-2" alt=""> Spotify</button>
            <button class="w-full custom-border bg-[#000] flex justify-center text-white px-2 py-3 items-center relative border-white" > <img src="@/assets/spotify.svg" class="h-8 absolute left-2" alt=""> Spotify</button>
            <button class="w-full custom-border bg-[#000] flex justify-center text-white px-2 py-3 items-center relative border-white" > <img src="@/assets/spotify.svg" class="h-8 absolute left-2" alt=""> Spotify</button>
            <button class="w-full custom-border bg-[#000] flex justify-center text-white px-2 py-3 items-center relative border-white" > <img src="@/assets/spotify.svg" class="h-8 absolute left-2" alt=""> Spotify</button>
